...
- `Rgen` 是已发表 White-NCSM 截断分子的掩码范数，是正式
  固定点判据。`Rstrict` 是含线性 `lambda2` 的
  `D-D^dagger` 诊断。两者始终分别报告。
...
| 核 | `||lambda2||F` | `s_final` | `Rgen/Rgen0` | `Rstrict/Rstrict0` | MR 0B | 后 NCSM 基态 | 报告 `Nmax` | `s=0` 同空间 | 本征值变化 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| He4 | 0 | 87.5627 | 8.015e-7 | 8.015e-7 | -20.2399184011 | -20.2399185504 | 8 | -20.3388325043 | +0.0989139539 |
| Be8 | 2.439406 | 341.4413 | 6.268e-7 | 8.987e-7 | -27.6449723642 | -27.9391351682 | 4 | -25.1799853478 | -2.7591498204 |
| C12 | 2.185990 | 273.7649 | 2.342e-7 | 9.693e-7 | -43.3080111039 | -43.5312362939 | 4 | -40.2376145487 | -3.2936217452 |
| O16 | 0 | 82.0767 | 7.703e-7 | 7.703e-7 | -63.7200911877 | -63.7200911998 | 4 | -62.2980557824 | -1.4220354174 |
...
非对角。公式在临时连通块自然基中计算，生成元变回 HO 基后再施加
`Delta e` 掩码，最终 Hamiltonian 保持原 HO 轨道顺序。

| 核 | `||lambda2||F` | HO 基 `max|gamma1_offdiag|` | `s_final` | `Rgen/Rgen0` | `Rstrict/Rstrict0` | MR 0B | 后 NCSM 基态 |
|---|---:|---:|---:|---:|---:|---:|---:|
| He4 | 0.598982 | 0.0722519 | 待填 | 待填 | 待填 | 待填 | 待填 |
| O16 | 1.082447 | 0.0429950 | 待填 | 待填 | 待填 | 待填 | 待填 |

这两个作业的正式验收使用 `Rgen`。`Rstrict` 会保留为生成元截断
