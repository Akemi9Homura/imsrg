...
//          .def("SetE3max", &Operator::SetE3max)
      ...
      py::class_<ReadWrite>(m, "ReadWrite")
          ...
          .def("Read_jcoupled64", &ReadWrite::Read_jcoupled64)
          .def("Write_jcoupled64", &ReadWrite::Write_jcoupled64)
      ...
      py::class_<Generator>(m, "Generator")
          ...
          .def("Get1bDenominatorWhiteNCSM",
               &Generator::Get1bDenominatorWhiteNCSM,
               py::arg("i"), py::arg("j"))
          .def(
              "Get2bDenominator",
          ...
          .def("Get2bDenominatorWhiteNCSM",
               &Generator::Get2bDenominatorWhiteNCSM,
               py::arg("channel"), py::arg("bra"), py::arg("ket"))
